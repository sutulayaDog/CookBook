...
import by.bstu.fit.alexsandrova.projectbd.ResipeActivity.ResipeActivity;
...
public class CategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.resipelistView);
        setTitle("Рецепты из выбранной категории");
    ...
    AdapterView.OnItemClickListener defaultItemClickOfList = (parent, view, position, id) -> {
        ...
        Intent intent = new Intent(CategoryActivity.this, ResipeActivity.class);
        ...
        popupMenu.setOnMenuItemClickListener((menu) -> {
            switch (menu.getItemId()) {
                ...
                case R.id.action_updateResipe:
                    Intent intent4 = new Intent(CategoryActivity.this, AddResipeActivity.class);
    ...
    private void loadLists(){
        String idCategorie = getIntent().getStringExtra("idCategorie");
        list = new ArrayList<>();

        Cursor cursor= getContentResolver().query(UriBuilder.getUri(UriBuilder.RESIPE),
                null, "IdCategorie = ? and (Status is null or Status != 'R')",
                new String[] {idCategorie}, null);
